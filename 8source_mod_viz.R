# Read in jags model
# jags.mod8habxses <- readRDS("D:/Wieteke's Stuff/MANWR Ecological Monitoring/MANWR Study/Stable Isotope Analysis/Analysis/git/MANWR_Mus_musculus_diet/jags.mod8habxses.Rds")
